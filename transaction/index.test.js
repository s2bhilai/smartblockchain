...
describe("Transaction", () => {
  ...
  describe("validateStandardTransaction()", () => {
    ...
    it("does not validate when gas limit exceeds the balance", () => {
      standardTransaction = Transaction.createTransaction({
        account,
        to: "foo-recipient",
        gasLimit: 9001,
    ...
    it("does not validate when the gasUsed for the code exceeds gasLimit", () => {
      ...
      ).rejects.toMatchObject({ message: /Transaction needs more/ });
    });
  });
